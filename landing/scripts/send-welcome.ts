...
async function main() {
  ...
  const info = await transporter.sendMail({
    from: '"Quetzito 🌱" <hola@quetz.org>',
    to: toEmail,
    subject: `¡Bienvenida a Quetz, ${name}! Tu árbol ya está en Zacapa 🌱`,
    html: `
<!DOCTYPE html>
<html>
<head>
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="color:#4a4a4a; font-size:16px; line-height:1.6; margin:0 0 20px;">
                Soy <strong>Quetzito</strong>, tu guía en esta aventura verde. 🦜
              </p>

              <p style="color:#4a4a4a; font-size:16px; line-height:1.6; margin:0 0 20px;">
                Gracias por dar este paso tan importante. Con tu apoyo has <strong>adoptado un árbol en Zacapa, Guatemala</strong> — una de las regiones más hermosas y necesitadas del país. Tu árbol crecerá allí, cuidado con amor por familias locales que conocen esa tierra como nadie.
              </p>
              ...
              <p style="color:#4a4a4a; font-size:15px; line-height:1.6; margin:0 0 20px;">
                En los próximos días te enviaré actualizaciones sobre tu árbol y el avance de la escuela. Puedes ver el estado de tu bosque en cualquier momento:
              </p>
          ...
          <tr>
            <td style="background-color:#f8f9fa; padding:24px 40px; border-top:1px solid #e9ecef;">
              <p style="color:#6c757d; font-size:13px; margin:0; text-align:center; line-height:1.6;">
                Con cariño, <strong>Quetzito</strong> y el equipo de <strong>Quetz</strong> 🌱<br>
