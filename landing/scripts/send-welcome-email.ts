...
async function main() {
  console.log('🔍 Buscando el último cliente en la base de datos...');
  ...
  if (!lastAdoption) {
    ...
    console.log(`\n📋 Último cliente (por suscripción):`);
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="color:#4a4a4a; font-size:15px; line-height:1.6; margin:0;">
                Si tienes cualquier pregunta, responde a este email o escríbenos a <a href="mailto:hola@quetz.org" style="color:#2d6a4f;">hola@quetz.org</a>.
              </p>
            </td>
          </tr>
