  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "bg-[#081C15]/90 backdrop-blur-md shadow-lg" : "bg-transparent"}`}>
      <div className="container flex items-center justify-between py-4">
        ...
        <a href="#kontakt">
          <button className="bg-[#52B788] hover:bg-[#40916C] text-white font-[Montserrat] font-semibold text-sm px-6 py-2 rounded-lg transition-colors">
            Jetzt starten
          </button>
        </a>
      </div>
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container text-center pt-24">
        ...
        >
          <a href="#kontakt">
            <button className="bg-[#52B788] hover:bg-[#40916C] text-white font-[Montserrat] font-bold text-base px-8 py-6 shadow-xl shadow-[#52B788]/20 rounded-lg transition-colors flex items-center">
              Kostenlose Demo buchen
              <ChevronRight className="ml-2 w-5 h-5" />
            </button>
          </a>
          <a href="#impact">
            <button className="border border-white/30 text-white hover:bg-white/10 font-[Montserrat] font-semibold text-base px-8 py-6 bg-transparent rounded-lg transition-colors flex items-center">
              Impact entdecken
      ...
      {/* Mascots flanking the hero */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {/* Quetzito – left */}
        <motion.div
          className="absolute left-4 md:left-16 bottom-20 md:bottom-28"
        ...
        >
          <motion.img
            ...
            alt="Quetzito"
            className="w-[120px] md:w-[220px] h-auto drop-shadow-2xl"
            animate={{
              y: [0, -12, 0],
              rotate: [-3, 3, -3],
            }}
        ...
        {/* Quetzita – right */}
        <motion.div
          className="absolute right-4 md:right-16 bottom-20 md:bottom-28"
          initial={{ opacity: 0, x: 80, scale: 0.8 }}
          animate={{ opacity: 1, x: 0, scale: 1 }}
          transition={{ duration: 1, delay: 1.6 }}
        >
          ...
          {plans.map((plan, i) => (
            <FadeInSection key={i} delay={i * 0.12}>
              <div className={`relative p-8 rounded-2xl h-full flex flex-col ${plan.highlight
                ...
                <a href="#kontakt">
                  <button className={`w-full font-[Montserrat] font-semibold rounded-lg transition-colors py-3 ${plan.highlight
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <FadeInSection>
            ...
            <div className="grid grid-cols-3 gap-6">
              {[
                { icon: Heart, value: "✓", label: "Stärkere Mitarbeiterbindung" },
                { icon: Globe, value: "✓", label: "Authentische Social-Media-Inhalte" },
          ...
          <FadeInSection delay={0.2}>
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full bg-[#52B788] hover:bg-[#40916C] text-white font-[Montserrat] font-bold text-base py-6 shadow-xl shadow-[#52B788]/20 rounded-lg transition-colors flex items-center justify-center"
                >
                  Kostenlose Demo buchen
                  <ChevronRight className="ml-2 w-5 h-5" />
                </button>
